/* ============================================================
   ...
   Curated source directory for Indonesian financial news.
   Articles are populated when you run fetch_data.py.
   ============================================================ */
window.NEWS_DATA = {
  updated: "2026-05-23",
  source: "Curated source directory. Run fetch_data.py to fetch live RSS headlines where available.",
  sources: [
